  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-indigo-300/20 dark:bg-indigo-600/10 rounded-full blur-3xl" />
        <div className="absolute top-40 right-1/4 w-96 h-96 bg-violet-300/20 dark:bg-violet-600/10 rounded-full blur-3xl" />
      ...
      {/* Results Section */}
      {hasSearched && (
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-16 w-full">
          ...
          {/* Error state */}
          {error && (
            <div className="p-4 rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 mb-6">
          ...
          {dontRuleOut.length > 0 && (
            <div className="mt-10">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {dontRuleOut.map((disease) => (
                  <DiseaseCard key={disease.id} {...disease} isWarning />
                ))}
              </div>
            </div>
          )}
